#!/usr/bin/env bash
#!/usr/bin/env bash
#$ -j y -o /home/lmarvin/BabyTrain_multilabel/validate_log.txt
#$ -e /home/lmarvin/BabyTrain_multilabel/validate_err.txt
...
pyannote-multilabel validate --parallel=2 --gpu --every=1 $CLASS ${TRAIN_DIR} $protocol --use_der
